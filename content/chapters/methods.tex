...
\Cref{tab:paginate} uses the xltabular environment, which paginates automatically at row boundaries and always targets the text width: height and width overflow are both impossible by construction. The header repeats on each continuation page.
